...
public class BoardHandler {
  ...
  static void processDelete() {
    ...
    int boardNo = Prompt.inputInt("삭제하실 게시글 번호?");
  ...
  static void processUpdate() {
    ...
    int boardNo = Prompt.inputInt("변경하실 게시글 번호?");
    ...
    String tempTitle = Prompt.inputString("제목? " + "(" + board.title + ")");
    String tempContent = Prompt.inputString("내용? " + "(" + board.content + ")");

    while(true) {
      String str = Prompt.inputString("변경하시겠습니까?(y/n)");
      if (str.equals("y")){
        System.out.println("변경했습니다.");
        board.title = tempTitle;
        board.content = tempContent;
        break;
      }
      else if (str.equals("n")) {
        System.out.println("변경 취소됐습니다.");
        break;
      }
      else {
        continue;
